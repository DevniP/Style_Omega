...
public class Database extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.example.dev.styleomega/databases/";

    private static String DB_NAME = "style.db";
    ...
    public Cursor runSQLSelect(String sql){
